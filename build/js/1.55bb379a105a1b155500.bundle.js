...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(page) {var Articles, Error404, Home, Main, SceneTraveler,
	...
	Articles = __webpack_require__(9);

	Error404 = __webpack_require__(10);
	...
	Main = (function() {
	  function Main(callbackLoad) {
	    ...
	    for (i = 0, len = links.length; i < len; i++) {
	      link = links[i];
	      link.addEventListener('click', this.onLink);
	    ...
	    page();
	    callbackLoad(1);
	    document.addEventListener('touchstart', this.fullScreen, true);
	    return;
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var require;var require;/* WEBPACK VAR INJECTION */(function(page) {!function(e){if(true)module.exports=e();else if("function"==typeof define&&define.amd)define([],e);else{var f;"undefined"!=typeof window?f=window:"undefined"!=typeof global?f=global:"undefined"!=typeof self&&(f=self),f.page=e()}}(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return require(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
	(function (process){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Home, HtmlUtils, Scene,
	  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	  hasProp = {}.hasOwnProperty;

	Scene = __webpack_require__(7);

	HtmlUtils = __webpack_require__(8);

	Home = (function(superClass) {
	  extend(Home, superClass);

	  function Home() {
	    var description, image, title, url;
...
/***/ function(module, exports, __webpack_require__) {
	...
	Scene = (function() {
	  ...
	  Scene.prototype.initState = function() {
	    var key, o, value;
	    o = {};
	    for (key in this) {
	      value = this[key];
	    ...
	    this.changeStateAt(0, o);
	  };

	  Scene.prototype.changeStateAfter = function(delay, params) {
	    var lastTime;
	    delay *= 1000;
	    if (this.states.length === 0) {
	      lastTime = 0;
	    } else {
	      lastTime = this.states[this.states.length - 1].time;
	    }
	    this.changeStateAt((lastTime + delay) / 1000, params);
	  };

	  Scene.prototype.changeStateAt = function(time, params) {
	    time *= 1000;
	    this.states.push({
	      time: time,
	      params: params
	  ...
	  Scene.prototype.updateState = function(time) {
	    var i, k, key, len, limit, ref, ref1, state, value;
	    limit = time - this.startTime;
	    if (limit < this.lastTimeCheck) {
	      this.lastTimeCheck = -1;
	    }
	    k = 0;
	    ref = this.states;
	    for (i = 0, len = ref.length; i < len; i++) {
	      state = ref[i];
	      if (state.time > limit) {
	        this.lastTimeCheck = limit;
	        break;
	      }
	      if (state.time <= limit && state.time > this.lastTimeCheck) {
	        ref1 = state.params;
	        for (key in ref1) {
	          value = ref1[key];
...
/***/ function(module, exports) {
	...
	HtmlUtils = (function() {
	  ...
	  HtmlUtils.getMeta = function(property, doc) {
	    var i, len, meta, metas;
	    if (doc == null) {
	      doc = document;
	    }
	  ...
	  HtmlUtils.getAllMeta = function(doc) {
	    var i, len, meta, metas, result;
	    if (doc == null) {
	      doc = document;
	    }
	    result = {};
	  ...
	  HtmlUtils.changeMeta = function(property, value, doc) {
	    var i, len, meta, metas;
	    if (doc == null) {
	      doc = document;
	    }
	  ...
	  HtmlUtils.updateMetaFB = function(title, description, url, image, doc) {
	    HtmlUtils.changeMeta("og:title", title, doc);
	    HtmlUtils.changeMeta("og:description", description, doc);
	    HtmlUtils.changeMeta("og:url", url, doc);
	    HtmlUtils.changeMeta("og:image", image, doc);
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Articles, HtmlUtils, Scene, Stage,
	  bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
	  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	  hasProp = {}.hasOwnProperty;
	...
	Articles = (function(superClass) {
	  extend(Articles, superClass);

	  function Articles(id) {
	    this.resize = bind(this.resize, this);
	    Articles.__super__.constructor.call(this, 'Article - ' + id);
	  ...
	  Articles.prototype.destroyIframe = function() {
	  ...
	  Articles.onReady = function() {
	    var doc;
	    doc = Articles.iframe.contentWindow.document;
	    HtmlUtils.updateMetaFB(HtmlUtils.getMeta("og:title", doc), HtmlUtils.getMeta("og:description", doc), HtmlUtils.getMeta("og:url", doc), HtmlUtils.getMeta("og:image", doc));
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	Error404 = (function(superClass) {
	  extend(Error404, superClass);

	  function Error404(id) {
	    Error404.__super__.constructor.call(this);
	    return;
	  }

	  Error404.prototype.transitionIn = function() {};

	  Error404.prototype.transitionOut = function() {};

	  Error404.prototype.resize = function() {};

	  Error404.prototype.dispose = function() {};
